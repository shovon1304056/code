...
@guest
    ...
    @else
   <!-- ####### START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href="{{route('admin.home')}}"><i class="icon ion-android-star-outline"></i> E-Commerce</a></div>
    <div class="sl-sideleft">
        ...
        <div class="sl-sideleft-menu">
            ...
            <ul class="sl-menu-sub nav flex-column">
                ...
                <li class="nav-item"><a href="{{route('subCategories')}}" class="nav-link">SubCategories</a></li>
            ...
            <ul class="sl-menu-sub nav flex-column">
                ...
                <li class="nav-item"><a href="{{route('product.all')}}" class="nav-link">All Products</a></li>
            ...
            <ul class="sl-menu-sub nav flex-column">
                <li class="nav-item"><a href="{{route('newslaters')}}" class="nav-link">Newslaters</a></li>
