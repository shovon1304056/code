          ...
          <div class="table-wrapper">
            ...
            @foreach($sub_category as $key=>$subcat)
                <tr>
                  ...
                  <td>
                    <a href="{{route('edit.subcategory',$subcat->id)}}" class="btn btn-sm btn-info">Edit</a>
                    <a href="{{route('delete.subcategory',$subcat->id)}}" class="btn btn-sm btn-danger" id="delete">Delete</a>
                  </td>
                </tr>
            @endforeach
              </tbody>
