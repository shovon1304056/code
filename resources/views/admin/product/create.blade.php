          ...
          <div class="form-layout">
            <div class="row mg-b-25">
              ...
              <div class="col-lg-4">
				 ...
				 <input type="file" id="file" class="custom-file-input" name="image_one" onchange="readURL1(this);" accept="image/*" required="true">
              ...
              <div class="col-lg-4">
              	...
              	<label class="custom-file">
				  <input type="file" id="file" class="custom-file-input" name="image_two" onchange="readURL2(this);" accept="img/*" required="true" >
				  <span class="custom-file-control"></span>
				  <img src="#" id="two" >
				</label>
              </div>
              <div class="col-lg-4">
              	...
              	<label class="custom-file">
				  <input type="file" id="file" class="custom-file-input" name="image_three" onchange="readURL3(this);" accept="img/*" required="true">
				  <span class="custom-file-control"></span>
				  <img src="#" id="three" >
				</label>
              </div>
